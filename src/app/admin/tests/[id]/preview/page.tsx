      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            >
              <ArrowLeft className="w-3.5 h-3.5" /> Teacher Hub
            </Link>
            <Link
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-sm transition"
              target="_blank"
            >
              <PlayCircle className="w-4 h-4" />
              <span>Simulate Student CBT Exam</span>
              <ExternalLink className="w-3 h-3" />
            </Link>
            <Link
              href={`/admin/tests/${test.id}/assign`}
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 text-xs font-bold shadow-sm transition"
            >
