...
describe("Phase 10 AI Paper Selection & Integrity Engine Suite", () => {
  ...
  const createMockQuestion = (
    ...
    options: [
      { id: `opt-${id}-A`, question_id: id, option_key: "A", content_latex: "A", is_correct: true, order_index: 1, created_at: "2026-01-01" },
      { id: `opt-${id}-B`, question_id: id, option_key: "B", content_latex: "B", is_correct: false, order_index: 2, created_at: "2026-01-01" },
      { id: `opt-${id}-C`, question_id: id, option_key: "C", content_latex: "C", is_correct: false, order_index: 3, created_at: "2026-01-01" },
      { id: `opt-${id}-D`, question_id: id, option_key: "D", content_latex: "D", is_correct: false, order_index: 4, created_at: "2026-01-01" },
    ],
  });
