      ...
      questions: [
        {
          ...
          question: {
            ...
            options: [
              { id: "opt-1", question_id: "q-101", option_key: "A", content_latex: "0", is_correct: false, order_index: 1, created_at: new Date().toISOString() },
              { id: "opt-2", question_id: "q-101", option_key: "B", content_latex: "1", is_correct: true, order_index: 2, created_at: new Date().toISOString() },
              { id: "opt-3", question_id: "q-101", option_key: "C", content_latex: "-1", is_correct: false, order_index: 3, created_at: new Date().toISOString() },
              { id: "opt-4", question_id: "q-101", option_key: "D", content_latex: "\\infty", is_correct: false, order_index: 4, created_at: new Date().toISOString() },
            ],
          },
        },
      ],
